	...
	<div class="container">
		<header class="header">
			...
			<div class="buttons">
				...
				<button class="button">
					<img src="img/icon/shopping-cart.svg" alt="shopping cart" class="button-icon">
				...
				<div class="cards">
					<div class="card">
						...
						<div class="card-text">
							...
							<!-- /.card-heading -->
							<div class="card-info">
								<div class="rating"><img src="img/icon/star.svg" alt="" class="rating-star">4.5</div>
					...
					<div class="card">
						...
						<div class="card-text">
							...
							<div class="card-info">
								<div class="rating"><img src="img/icon/star.svg" alt="" class="rating-star">4.5</div>
								<div class="price">От 900 р</div>
								<div class="category">Русская кухня и китайская</div>
							</div>
							<!-- /.card-info -->
						</div>
						<!-- /.card-text -->
	...
	<footer class="footer">
		<div class="container">
			<div class="footer-block">
				...
				<div class="social">
					<a href="#" class="social-link"><img src="img/icon/Group 1.svg" alt="instagram"></a>
					<a href="#" class="social-link"><img src="img/icon/Group 2.svg" alt="facebook"></a>
					<a href="#" class="social-link"><img src="img/icon/Group 3.svg" alt="vk"></a>
				</div>
			</div>
			<!-- /.footer-block -->
		</div>
